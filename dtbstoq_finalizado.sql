...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27-Nov-2023 às 05:56
...
--
-- Extraindo dados da tabela `tbdcadloc`
--
...
--
-- Estrutura da tabela `tbdcadprod`
--
...
--
-- Extraindo dados da tabela `tbdcadprod`
--
...
(2, 'Monitor LED', 1.3, 'DELL', 40, 30, 30, 0, 36000),
(3, 'Teclado', 150, 'Multilaser', 40, 8, 15, 0, 4800),
(4, 'PLACA DE VÍDEO', 2.55, 'NVIDIA', 20, 2, 10, 0, 400),
(5, 'GABINETE GAMER', 1.2, 'RAZER', 30, 40, 30, 0, 36000),
...
--
-- Estrutura da tabela `tbdordementrada`
--
...
--
-- Extraindo dados da tabela `tbdordementrada`
--
...
--
-- Estrutura da tabela `tbdordemsaida`
--
...
--
-- Extraindo dados da tabela `tbdordemsaida`
--
...
--
ALTER TABLE `tbdordementrada`
  MODIFY `id_OrdemEntrada` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=161;

--
-- AUTO_INCREMENT de tabela `tbdordemsaida`
--
ALTER TABLE `tbdordemsaida`
  MODIFY `id_OrdemSaida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
